...
// 1. Rewrite participant.js
let pContent = fs.readFileSync('/home/nocturn/OAA/Tekathon5.0/tekathon-backend/routes/participant.js', 'utf8');

// Remove resend imports
pContent = pContent.replace("const { Resend } = require('resend');\nconst resend = new Resend(process.env.RESEND_API_KEY);\n", "const fetch = require('node-fetch');\n");
...
pContent = pContent.replace(/async function sendOTPEmail\(email, code\) \{[\s\S]*?\}\s*\}\n/s, newSendOTPEmail);
fs.writeFileSync('/home/nocturn/OAA/Tekathon5.0/tekathon-backend/routes/participant.js', pContent);


// 2. Rewrite emailService.js
const eContent = `const fetch = require('node-fetch');
...
fs.writeFileSync('/home/nocturn/OAA/Tekathon5.0/tekathon-backend/services/emailService.js', eContent);
console.log('GAS rewritten done!');
